...
def lr_scheduler(epoch, argdict):
    ...
    lr gets divided by 100. Up until this point, the orthogonalization
    technique is performed (--no_orthog to set it off).
    """
...
def validate_and_log(
    ...
    try:
        ...
        writer.add_image(
            'Reconstructed validation image {}'.format(idx),
            irecon,
            epoch,
        )
